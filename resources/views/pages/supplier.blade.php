            ...
            <div class="modal-body">
                <form id="addDataForm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Contoh: PT. Farmasi Indonesia" required>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Contoh: Jl. Industri No. 123" required></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="telepon" id="telepon" placeholder="Contoh: 021-12345678" required>
                    </div>
